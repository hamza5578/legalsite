...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "Babar Manzoor is the Founding Partner of Shafi Law Associates and an Advocate of the Supreme Court of Pakistan. With over two decades of practice, he leads the firm's civil litigation and constitutional law work, representing clients in high-stakes disputes before the Islamabad High Court and the Supreme Court. He is known for meticulous case preparation and decisive courtroom advocacy.",
  ...
  },
  {
    ...
    bio: "Gufraan Manzoor heads the firm's corporate and property practice. He advises businesses on company formation, commercial contracts, mergers, and real estate transactions across Pakistan. His commercially focused approach has made him the trusted counsel for entrepreneurs, investors, and established enterprises navigating Pakistan's regulatory environment.",
  ...
  },
  {
    ...
    bio: "Farhan Manzoor is the firm's criminal defense and tax law specialist. He represents clients in sessions courts, the Islamabad High Court, and before the FBR in tax disputes and audit proceedings. Farhan is known for his thorough understanding of criminal procedure and his ability to identify legal defenses that others overlook.",
