...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "Founding Partner of Shafi Law Associates with over two decades of practice in criminal defense and constitutional law. He represents clients in high-stakes matters before the Islamabad High Court and the Supreme Court, combining meticulous case preparation with decisive courtroom advocacy.",
  ...
  },
  {
    ...
    bio: "Senior Partner with a commanding practice spanning criminal defense, customs regulation, anti-narcotics proceedings, and emerging cyber law. He defends clients against complex federal charges and digital offences with equal authority, bringing strategic depth and courtroom confidence to some of the firm's most demanding cases.",
  ...
  },
  {
    ...
    title: "Partner",
    role: "Advocate High Court",
    specialization: "Family Law & Banking Disputes",
    bio: "Advises clients across family law, banking disputes, and immigration matters, offering clear and compassionate guidance through some of life's most consequential legal challenges. He is known for achieving practical outcomes in both contentious and advisory matters across these interconnected areas of law.",
